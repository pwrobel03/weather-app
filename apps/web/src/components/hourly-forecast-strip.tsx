        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col items-center">
              <span className={`font-mono text-xl sm:text-2xl leading-none font-bold tabular-nums tracking-tight ${isCurrent ? "text-white drop-shadow-sm" : "text-foreground"
                }`}>
            ...
            {/* Bottom: Time */}
            <span className={`font-mono text-xs tabular-nums tracking-wide ${isCurrent ? "font-bold text-white/95" : "font-medium text-muted-foreground group-hover/hour:text-foreground/90"
              }`}>
